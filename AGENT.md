...
4. Always use Context7 MCP when confused about a library, framework, SDK, API, CLI, cloud service, or when introducing a new tool/pattern. Fetch current docs and base best-practice decisions on official/current documentation rather than memory.